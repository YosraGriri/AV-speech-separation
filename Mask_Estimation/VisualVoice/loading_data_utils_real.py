...
def get_separated_audio(outputs, batch_data, opt, wav=False):
    ...
    #########Saving Files
    np.save('model_results/model_output/target_mask.npy', pred_masks_1)
    np.save('model_results/model_output/noise_mask.npy', pred_masks_2)
    #np.save('model_results/model_output/pred_spec_1_real.npy', pred_spec_1_real)
    #np.save('model_results/model_output/pred_spec_1_imag.npy', pred_spec_1_imag)
    #np.save('model_results/model_output/pred_spec_2_real.npy', pred_spec_2_real)
    #np.save('model_results/model_output/pred_spec_2_imag.npy', pred_spec_2_imag)
